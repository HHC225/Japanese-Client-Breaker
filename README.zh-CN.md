...
在很多日本企业的审查场景里，尤其是银行和保险行业，即使成果物本身不错，也仍然会失败。如果：
...
```text
请从严格的日本客户视角分析 `input/` 中的成果物，运行完整防御流水线，并生成 HTML 报告。
```
...
- 需要准备高压客户审查的咨询团队
- 面对日本银行、保险公司和大型企业的交付团队
- 需要“捍卫建议”而不仅仅是“写建议”的战略与 PM 团队
- 正在构建高摩擦企业说服型 agent workflow 的操盘者
...
如果这个 harness 帮你赢下艰难评审、扛过残酷客户会议，或者成功说服了日本银行或保险公司，请把你有效的模式、边界案例、表达方式或改进内容补充进来，并提交 pull request。
