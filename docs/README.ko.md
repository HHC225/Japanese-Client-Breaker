...
5. 생성된 보고서 `_workspace/latest/defense-report.html`을 엽니다 (또는 `_workspace/run_YYYYMMDD_HHMMSS/`).
...
- `_workspace/`
  실행 시 생성됩니다. 매 실행마다 타임스탬프 하위 디렉토리(`run_YYYYMMDD_HHMMSS/`)가 생성되며, `latest` 심볼릭 링크가 가장 최근 실행을 가리킵니다.
- `CLAUDE.md`
